...
from iemlav.lib.antivirus.update.update_hash import UpdateHash
from iemlav.lib.antivirus.update.update_yara import UpdateYara

# Import Core Engines
from iemlav.lib.antivirus.scanner.scanner_engine import ScannerEngine
from iemlav.lib.antivirus.monitor.monitor_engine import MonitorEngine

# Import helper utils
from iemlav.lib.antivirus.cleaner.cleaner import Cleaner
from iemlav.lib.antivirus.tools.file_gather import GatherFile
...
class CoreEngine(object):
    ...
    def __init__(self,
                 debug=False,
                 config_path="iemlav/lib/antivirus/config/config.json",
                 vt_api_key=None,
                 monitor_changes=1,
                 monitor_usb=1,
                 update=1,
