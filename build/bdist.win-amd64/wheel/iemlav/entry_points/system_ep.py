...
from iemlav.args import args_helper
from iemlav.modes import system_mode
from iemlav.lib.firewall.utils import get_interface
import platform
import argparse
...
def get_credentials():
    ...
    if (config_decision.lower() == "Y" or
        ...
        # Fetch credentials
        creds = args_helper_obj.iemlav_conf.get_creds(args_helper_obj.args)
