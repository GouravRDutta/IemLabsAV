...
class TestServerUtils(unittest.TestCase):
    ...
    @patch("iemlav.lib.log_monitor.server_log.utils.datetime")
    ...
    @staticmethod
    @patch("iemlav.lib.log_monitor.server_log.utils.open")
    ...
    @patch("iemlav.lib.log_monitor.server_log.utils.get_system_name")
    ...
    @patch("iemlav.lib.log_monitor.server_log.utils.platform")
    ...
    @patch("iemlav.lib.log_monitor.server_log.utils.os")
