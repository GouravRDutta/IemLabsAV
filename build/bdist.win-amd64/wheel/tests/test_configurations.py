...
from iemlav.configurations import IemlAVConf
import argparse
import json
...
class TestConfigurations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.conf_obj = configurations.IemlAVConf()
        self._CONFIG_PATH = '/home/gourav/Desktop/IEMLAV/iemlav.conf'
    ...
    def test_get_json(self):
        ...
        self.assertEqual(self.creds,
                         self.conf_obj.get_json(path='/home/gourav/Desktop/IEMLAV/iemlav.conf'))

    @patch.object(IemlAVConf, "get_json")
    ...
    @patch('iemlav.configurations.os')
