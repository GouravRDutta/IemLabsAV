...
class TestInstaller(unittest.TestCase):
    ...
    @patch("iemlav.lib.auto_server_patcher.installer.subprocess")
    @patch("iemlav.lib.auto_server_patcher.installer.utils")
    ...
    @patch.object(Installer, "open_json")
    @patch("iemlav.lib.auto_server_patcher.installer.open")
    @patch("iemlav.lib.auto_server_patcher.installer.utils")
