...
class TestAntiVirusUtils(unittest.TestCase):
    ...
    @patch("iemlav.lib.antivirus.tools.utils.extractBytes")
    ...
    @staticmethod
    @patch("iemlav.lib.antivirus.tools.utils.open")
    ...
    @patch("iemlav.lib.antivirus.tools.utils.get_system_name")
    ...
    @patch("iemlav.lib.antivirus.tools.utils.platform")
    ...
    @patch("iemlav.lib.antivirus.tools.utils.os")
    ...
    @patch("iemlav.lib.antivirus.tools.utils.subprocess")
