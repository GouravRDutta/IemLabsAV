# -*- coding: utf-8 -*-
import unittest
from iemlav.lib.log_monitor.system_log.ssh_login import SSHLogin
...
class TestSSHLogin(unittest.TestCase):
    ...
    @patch('iemlav.lib.log_monitor.system_log.ssh_login.utils')
    ...
    @patch('iemlav.lib.log_monitor.system_log.ssh_login.time')
