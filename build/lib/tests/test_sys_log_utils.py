...
class TestUtils(unittest.TestCase):
    ...
    @patch("iemlav.lib.log_monitor.system_log.utils.platform")
    ...
    @patch("iemlav.lib.log_monitor.system_log.utils.get_system_name")
    ...
    @patch("iemlav.lib.log_monitor.system_log.utils.os")
