# -*- coding: utf-8 -*-
import unittest
from iemlav.lib.log_monitor.server_log.parser.nginx import NginxParser
...
class TestNginxParser(unittest.TestCase):
    ...
    @patch("iemlav.lib.log_monitor.server_log.parser.nginx.utils")
    ...
    @patch("iemlav.lib.log_monitor.server_log.parser.nginx.time")
