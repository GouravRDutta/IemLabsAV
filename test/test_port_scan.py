# -*- coding: utf-8 -*-
import unittest
from iemlav.lib.log_monitor.system_log.port_scan import PortScan
...
class TestPortScan(unittest.TestCase):
    ...
    @patch('iemlav.lib.log_monitor.system_log.port_scan.utils')
    ...
    @patch('iemlav.lib.log_monitor.system_log.port_scan.utils')
    @patch("iemlav.lib.log_monitor.system_log.port_scan.time")
