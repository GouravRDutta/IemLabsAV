...
class TestUpdateYara(unittest.TestCase):
    ...
    @patch("iemlav.lib.antivirus.update.update_yara.requests")
    @patch.object(UpdateYara, "current_status")
    @patch("iemlav.lib.antivirus.update.update_yara.helper")
    @patch("iemlav.lib.antivirus.update.update_yara.utils")
    ...
    @patch("iemlav.lib.antivirus.update.update_yara.wget")
    ...
    @patch("iemlav.lib.antivirus.update.update_yara.helper")
    @patch("iemlav.lib.antivirus.update.update_yara.utils")
    @patch("iemlav.lib.antivirus.update.update_yara.os")
