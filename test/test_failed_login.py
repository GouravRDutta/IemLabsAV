# -*- coding: utf-8 -*-
import unittest
from iemlav.lib.log_monitor.system_log.failed_login import FailedLogin
...
class TestFailedLogin(unittest.TestCase):
    ...
    @patch('iemlav.lib.log_monitor.system_log.failed_login.utils')
    ...
    @patch('iemlav.lib.log_monitor.system_log.failed_login.time')
