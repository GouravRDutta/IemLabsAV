...
class TestUpdateHash(unittest.TestCase):
    ...
    @staticmethod
    @patch("iemlav.lib.antivirus.update.update_hash.helper")
    @patch("iemlav.lib.antivirus.update.update_hash.utils")
    @patch.object(AntiVirusLogger, "log")
    @patch("iemlav.lib.antivirus.update.update_hash.os")
    ...
    @patch("iemlav.lib.antivirus.update.update_hash.wget")
    @patch.object(AntiVirusLogger, "log")
    @patch("iemlav.lib.antivirus.update.update_hash.utils")
    def test_download(mck_utils, mck_log, mck_wget, mck_rt, mck_helper):
        ...
        mck_wget.download.assert_called_with('https://www.virusshare.com/hashes/VirusShare_00000.md5',
                                             out='/etc/iemlav/antivirus/md5_hash/')
